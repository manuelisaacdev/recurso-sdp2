...
import com.bai.transacao.service.DepositoService;
import com.bai.transacao.service.LevantamentoService;
...
public class KafkaConsumerServiceImpl implements KafkaConsumerService {
	...
	@Override
	@KafkaListener(topics = KafkaTopicConfig.TOPIC_BAI_TRANSACAO_STATUS_TRANSACTION, groupId = "group-bank")
	public void receiveStatusTransaction(String payload) {
		log.info("========>  BAI TRANSACOES receiveStatusTransaction: " + payload);
		try {
	...
	@Override
	@KafkaListener(topics = KafkaTopicConfig.TOPIC_BAI_TRANSACAO_STATUS_TRANSFER, groupId = "group-bank")
	public void receiveStatusTransfer(String payload) {
		log.info("========>  BAI TRANSACOES receiveStatusTransferTransaction: " + payload);
		try {			
	...
	@Override
	@KafkaListener(topics = KafkaTopicConfig.TOPIC_BAI_TRANSACAO_HISTORY, groupId = "group-bank")
	public void receiveHistory(String payload) {
		log.info("========>  BAI TRANSACOES receiveHistory: " + payload);
		try {
	...
	@Override
	@KafkaListener(topics = KafkaTopicConfig.TOPIC_BAI_TRANSACAO_INTERBANK_TRANSFER, groupId = "group-bank")
	public void receiveinterbankTransfer(String payload) {
		log.info("========>  BAI TRANSACOES receiveinterbankTransfer: " + payload);
		try {
